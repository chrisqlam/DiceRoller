...
public class D4 extends AppCompatActivity implements GestureDetector.OnGestureListener {
    ...
    private void roll() {
        ...
        int roll = random.nextInt(4) + 1; //number between 1 - 4 inclusive

        //special messages
        if (roll == 4) {
            message.setText("A dice can be no smaller than 4 sides");
        } else {
            if (roll == 1) {
